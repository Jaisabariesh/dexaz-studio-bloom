    ...
    <section id="about" className="relative py-40 px-6" ref={sectionRef}>
      ...
      <div className="mx-auto max-w-7xl lg:px-4">
        <div className="grid gap-20 lg:grid-cols-12">
          {/* Story side */}
          <div className="lg:col-span-7 bg-[#ddfde1]">
            <motion.div
              initial={{ opacity: 0 }}
            ...
            <div className="overflow-hidden mb-10">
              <motion.h2
                ...
                className="font-display text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl bg-[#ddfde1]">
          ...
          <div className="flex flex-col gap-8 lg:col-span-5">
            ...
            <motion.div
              ...
              className="group cursor-default rounded-2xl border border-border p-8 transition-shadow duration-500 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] bg-[#ddfde1]">
